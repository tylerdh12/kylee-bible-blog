...
export default function EditPostClient({ post }: EditPostClientProps) {
	...
	const handleSave = async (publish?: boolean) => {
		...
		setLoading(true);
		try {
			const publishStatus = publish !== undefined ? publish : published;
			...
			const response = await fetch(`/api/posts/${slug}/${post.id}`, {
				method: 'PUT',
				credentials: 'include',
						...
						<CardContent className='space-y-4'>
							...
							<div className='space-y-2'>
								...
								<p className='text-sm text-muted-foreground'>
									Optional. If not provided, the first 150 characters
									of content will be used.
								</p>
							</div>
