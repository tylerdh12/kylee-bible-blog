		...
		<div className='container mx-auto px-4 py-8 max-w-2xl'>
			<div className='text-center mb-8'>
				<h1 className='text-4xl font-bold mb-4'>
					Support Kylee&apos;s Ministry
				</h1>
				<p className='text-xl text-muted-foreground'>
					Your generosity helps further Bible study
					resources, ministry outreach, and spreading
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Choose to support a specific goal or make a
						general donation to support the ministry.
					</CardDescription>
				</CardHeader>
				...
				<CardContent>
					...
					>
						...
						<div className='space-y-2'>
							...
							>
								Enter a donation amount in{' '}
								{currencyConfig.name} (minimum{' '}
								{formatAmount(1)})
							</p>
						</div>
			...
			<Card className='mt-8'>
				<CardContent className='py-6'>
					...
					<p className='text-sm text-muted-foreground'>
						Your donation helps Kylee continue her Bible
						study ministry, create valuable content, and
						reach more people with God&apos;s word. Every
						contribution, no matter the size, makes a
