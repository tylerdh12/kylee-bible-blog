  ...
  useEffect(() => {
    async function loadGoals() {
      try {
        ...
        try {
          const response = await fetch('/api/public/goals', {
    ...
    return (
      <Card>
        <CardContent className="py-12 text-center">
          <h3 className="text-xl font-semibold mb-4">Ministry Goals Coming Soon</h3>
          <p className="text-muted-foreground mb-4">
            Kylee is setting up ministry goals to support her Bible study journey and outreach.
          </p>
          <p className="text-sm text-muted-foreground">
            Check back soon for opportunities to support Bible study resources, ministry events,
